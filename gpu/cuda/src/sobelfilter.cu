...
__global__ void local_filter(unsigned char* input,unsigned char* output,int width, int height)
{
    ...
    __shared__ unsigned char localBlock[TILESIZE][TILESIZE]; // BLOCKSIZE=16; TILESIZE=18
