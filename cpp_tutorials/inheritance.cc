...
int main(void) {
  ...
  // second_ptr->ThirdFunc();    // error: no member named 'ThirdFunc' in
  // 'Second'

  first_ptr->FirstFunc();
  // first_ptr->SecondFunc();    // error: no member named 'SecondFunc' in
  // 'First' first_ptr->ThirdFunc();     // error: no member named 'ThirdFunc'
  // in 'First'
