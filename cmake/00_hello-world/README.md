...
It will build and install an application called HelloWorld which simply outputs "Hello, world!" to stdout.  
...
### Usage ###
Once the executable has been created simply call `HelloWorld`, either from the build directory or anywhere (if you installed to /usr/local/bin, etc).

***Uninstallation*** 
Removing the application is straight-forward.  Simply delete the binary 'HelloWorld' from /usr/local/bin.
