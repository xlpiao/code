...
__global__ void global_filter(unsigned char* input,unsigned char* output,int width, int height)
{
...
__global__ void global_filter_v2(unsigned char* input,unsigned char* output,int width, int height)
{
    Gx[0][0]=-1; Gx[0][1]=0; Gx[0][2]=1;
    Gx[1][0]=-2; Gx[1][1]=0; Gx[1][2]=2;
    Gx[2][0]=-1; Gx[2][1]=0; Gx[2][2]=1;
    ...
    if(tx<w && ty<h){
        ...
        pixelX = k00*Gx[0][0] + k01*Gx[0][1] + k02*Gx[0][2] +
                 k10*Gx[1][0] + k11*Gx[1][1] + k12*Gx[1][2] +
                 k20*Gx[2][0] + k21*Gx[2][1] + k22*Gx[2][2];
        pixelY = k00*Gy[0][0] + k01*Gy[0][1] + k02*Gy[0][2] +
