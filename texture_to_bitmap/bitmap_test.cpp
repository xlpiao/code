...
void test01()
{
   ...
   image.save_image("bmp/test01_saved.bmp");
}
...
void test02()
{
   ...
   image.save_image("bmp/test02_saved.bmp");

   image.vertical_flip();
   image.save_image("bmp/test02_saved_vert_flip.bmp");
   image.vertical_flip();

   image.horizontal_flip();
   image.save_image("bmp/test02_saved_horiz_flip.bmp");
}
...
void test03()
{
   ...
   subsampled_image1.save_image("bmp/test03_1xsubsampled_image.bmp");

   subsampled_image1.subsample(subsampled_image2);
   subsampled_image2.save_image("bmp/test03_2xsubsampled_image.bmp");

   subsampled_image2.subsample(subsampled_image3);
   subsampled_image3.save_image("bmp/test03_3xsubsampled_image.bmp");
}
...
void test04()
{
   ...
   upsampled_image1.save_image("bmp/test04_1xupsampled_image.bmp");

   upsampled_image1.upsample(upsampled_image2);
   upsampled_image2.save_image("bmp/test04_2xupsampled_image.bmp");

   upsampled_image2.upsample(upsampled_image3);
   upsampled_image3.save_image("bmp/test04_3xupsampled_image.bmp");
}
...
void test05()
{
   ...
   image.save_image("bmp/test05_lsb0_removed_saved.bmp");
   image.set_all_ith_bits_low(1);
   image.save_image("bmp/test05_lsb01_removed_saved.bmp");
   image.set_all_ith_bits_low(2);
   image.save_image("bmp/test05_lsb012_removed_saved.bmp");
   image.set_all_ith_bits_low(3);
   image.save_image("bmp/test05_lsb0123_removed_saved.bmp");
   image.set_all_ith_bits_low(4);
   image.save_image("bmp/test05_lsb01234_removed_saved.bmp");
   image.set_all_ith_bits_low(5);
   image.save_image("bmp/test05_lsb012345_removed_saved.bmp");
   image.set_all_ith_bits_low(6);
   image.save_image("bmp/test05_lsb0123456_removed_saved.bmp");
}
...
void test07()
{
   ...
   image.save_image("bmp/test07_grayscale_image.bmp");
}
...
void test08()
{
   ...
   image1.save_image("bmp/test08_upper_left_image.bmp");
   image2.save_image("bmp/test08_upper_right_image.bmp");
   image3.save_image("bmp/test08_lower_left_image.bmp");
   image4.save_image("bmp/test08_lower_right_image.bmp");
}
...
void test09()
{
   ...
   image.save_image("bmp/test09_color_map_image.bmp");
}
...
void test10()
{
   ...
   image.save_image("bmp/test10_inverted_color_image.bmp");
}
...
void test11()
{
   ...
   for (unsigned int i = 0; i < 10; ++i)
   {
      ...
      image.save_image(std::string("bmp/test11_") + static_cast<char>(48 + i) + std::string("_red_inc_image.bmp"));
   }
}
...
void test12()
{
   ...
   image.save_image("bmp/test12_only_y_image.bmp");
...
void test13()
{
   ...
   for (unsigned int j = 0; j < 10; ++j)
   {
      ...
      image.import_ycbcr(y,cb,cr);
      image.save_image(std::string("bmp/test13_") + static_cast<char>(48 + j) + std::string("_y_image.bmp"));
   }
...
void test14()
{
   ...
   image.save_image("bmp/test14_checkered_01.bmp");

   image.clear();
   checkered_pattern(32,64,100,200,50,image);
   image.save_image("bmp/test14_checkered_02.bmp");
}
...
void test15()
{
   ...
   image.save_image("bmp/test15_plasma.bmp");
}
...
void test16()
{
   ...
   temp_image.save_image("bmp/test16_alpha_0.1.bmp");
   temp_image = image;

   temp_image.alpha_blend(0.2, plasma_image);
   temp_image.save_image("bmp/test16_alpha_0.2.bmp");
   temp_image = image;

   temp_image.alpha_blend(0.3, plasma_image);
   temp_image.save_image("bmp/test16_alpha_0.3.bmp");
   temp_image = image;

   temp_image.alpha_blend(0.4, plasma_image);
   temp_image.save_image("bmp/test16_alpha_0.4.bmp");
   temp_image = image;

   temp_image.alpha_blend(0.5, plasma_image);
   temp_image.save_image("bmp/test16_alpha_0.5.bmp");
   temp_image = image;

   temp_image.alpha_blend(0.6, plasma_image);
   temp_image.save_image("bmp/test16_alpha_0.6.bmp");
   temp_image = image;

   temp_image.alpha_blend(0.7, plasma_image);
   temp_image.save_image("bmp/test16_alpha_0.7.bmp");
   temp_image = image;

   temp_image.alpha_blend(0.8, plasma_image);
   temp_image.save_image("bmp/test16_alpha_0.8.bmp");
   temp_image = image;

   temp_image.alpha_blend(0.9, plasma_image);
   temp_image.save_image("bmp/test16_alpha_0.9.bmp");
}
...
void test17()
{
   ...
   image.save_image("bmp/test17_image_drawer.bmp");
}
...
{
   {
      ...
      image.save_image("bmp/test18_color_maps.bmp");
   }

   {
      ...
      image.save_image("bmp/test18_palette_colormap.bmp");
   }
}
...
{
   {
      ...
      canvas.image().save_image("bmp/test19_cartesian_canvas01.bmp");
   }

   {
      ...
      canvas.image().save_image("bmp/test19_cartesian_canvas02.bmp");
   }
}
